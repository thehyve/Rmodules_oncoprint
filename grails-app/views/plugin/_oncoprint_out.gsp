...
<div id="oncoprint_legend" style="padding-left: 102px;"><table><tbody><tr><td style="padding-right:10px;">
    ...
    <span style="position: relative; bottom: 6px;">Homozygous Deletion</span>
</td><td style="padding-right:10px;">
    <svg height="23" width="6">
        <rect fill="#D3D3D3" width="5.5" height="23"></rect>

        <rect display="inherit" fill="#008000" y="7.666666666666667" width="5.5" height="7.666666666666667"></rect>
        <path display="none" d="M0,0L0,23 5.5,11.5Z"></path>
    ...
    <span style="position: relative; bottom: 6px;">Mutation</span>
</td><td style="padding-right:10px;">
    <svg height="23" width="6">
        <rect fill="#D3D3D3" width="5.5" height="23"></rect>
        ...
        <rect display="inherit" height="23" width="5.5" stroke-width="2" stroke-opacity="1" stroke="#6699CC" fill="none"></rect>
        <rect display="none" height="23" width="5.5" stroke-width="2" stroke-opacity="1" stroke="#FF9999" fill="none"></rect>
    </svg>
    <span style="position: relative; bottom: 6px;">mRNA Downregulation</span>
</td><td style="padding-right:10px;">
    <svg height="23" width="6">
        <rect fill="#D3D3D3" width="5.5" height="23"></rect>
        ...
        <rect display="none" height="23" width="5.5" stroke-width="2" stroke-opacity="1" stroke="#6699CC" fill="none"></rect>
        <rect display="inherit" height="23" width="5.5" stroke-width="2" stroke-opacity="1" stroke="#FF9999" fill="none"></rect>
    </svg>
    <span style="position: relative; bottom: 6px;">mRNA Upregulation</span>
</td></tr></tbody></table>

<p style="margin-top: 5px; margin-bottom: 5px;">Copy number alterations are putative.</p></div>
